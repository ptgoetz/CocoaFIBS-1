...
@interface MGGameController : NSWindowController
{
    IBOutlet MGGameView *theAGFIBSGameView;					/*" Reference to the game view this controlls "*/
	IBOutlet NSDrawer *userListDrawer;							/*" The drawe attached to this window "*/
	IBOutlet MGAppController *theAppController;				/*" Reference to the app controller "*/
	IBOutlet MGUserListWindowController *userListWindow;	/*" Reference to the user list window controller "*/
...
- (MGAppController *)theAppController;
- (void)setTheAppController:(MGAppController *)newTheAppController; 
- (MGGameView *)theAGFIBSGameView;
