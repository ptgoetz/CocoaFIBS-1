...
/*" Tokkenizes a request to play a match from another user. Displays the InviteToGame Window. "*/
{
	...
	MGInviteToGameWindowController *inviteToGameWindow;
	inviteToGameWindow = [[MGInviteToGameWindowController alloc] init];
...
- (void)awakeFromNib
{
	[theAGFIBSGameView setTheAGFIBSGameModel:[[MGGameModel alloc] init]];
