...
@interface MGGameView : NSView
{
	MGGameModel *theAGFIBSGameModel;	/*" Reference to the game model this view will display "*/
	...
	MGTriangle *draggedFromTriangle;	/*" The triangle where the user last dragged a chip from "*/
...
-(MGGameModel *)theAGFIBSGameModel; 
- (BOOL)isDragging;
